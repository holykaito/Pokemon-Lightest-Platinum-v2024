...
class Battle::AI
  ...
  BASE_ABILITY_RATINGS = {
    ...
    9  => [:ARENATRAP, :DRIZZLE, :DROUGHT, :IMPOSTER, :MAGICBOUNCE, :MAGICGUARD,
           :MAGNETPULL, :SANDSTREAM, :SPEEDBOOST, :FLUFFUP],
    8  => [:ADAPTABILITY, :AERILATE, :CONTRARY, :DISGUISE, :DRAGONSMAW, :SELFSUFFICIENT,
           :ELECTRICSURGE, :GALVANIZE, :GRASSYSURGE, :ILLUSION, :LIBERO,
           :MISTYSURGE, :MULTISCALE, :MULTITYPE, :NOGUARD, :POISONHEAL,
           :PIXILATE, :PRANKSTER, :PROTEAN, :PSYCHICSURGE, :REFRIGERATE, :DRAGONIZE,
           :REGENERATOR, :RKSSYSTEM, :SERENEGRACE, :SHADOWSHIELD, :SHEERFORCE,
           :SIMPLE, :SNOWWARNING, :TECHNICIAN, :TRANSISTOR, :WATERBUBBLE,
           :PRIDEFULGUARD, :RESILIENCE, :INTOXICATE],
    7  => [:BEASTBOOST, :BULLETPROOF, :COMPOUNDEYES, :DOWNLOAD, :FURCOAT,
           :HUSTLE, :ICESCALES, :INTIMIDATE, :LEVITATE, :LIGHTNINGROD,
           :MEGALAUNCHER, :MOLDBREAKER, :MOXIE, :NATURALCURE, :SAPSIPPER, :HUBRIS,
           :SHEDSKIN, :SKILLLINK, :SOULHEART, :STORMDRAIN, :TERAVOLT, :THICKFAT,
           :TINTEDLENS, :TOUGHCLAWS, :TRIAGE, :TURBOBLAZE, :UNBURDEN, :JUNGLECOMBAT,
           :VOLTABSORB, :WATERABSORB, :COTTONCLOAK, :ILLUMINATE, :TERRORSOWER],
    6  => [:BATTLEBOND, :CHLOROPHYLL, :COMATOSE, :DARKAURA, :DRYSKIN,
           :FAIRYAURA, :FILTER, :FLASHFIRE, :FORECAST, :GALEWINGS, :GUTS, :HYPERCHARGE,
           :INFILTRATOR, :IRONBARBS, :IRONFIST, :MIRRORARMOR, :MOTORDRIVE, :SPELLCASTER,
           :NEUROFORCE, :PRISMARMOR, :QUEENLYMAJESTY, :RECKLESS, :ROUGHSKIN,
           :SANDRUSH, :SCHOOLING, :SCRAPPY, :SHIELDSDOWN, :SOLIDROCK, :STAKEOUT, :GROUNDSHOCK,
           :STAMINA, :STEELWORKER, :STRONGJAW, :STURDY, :SWIFTSWIM, :TOXICBOOST,
           :TRACE, :UNAWARE, :VICTORYSTAR, :SPOREVEIL, :WILDTANTRUM, :PERMAFROST,],
    5  => [:AFTERMATH, :AIRLOCK, :ANALYTIC, :BERSERK, :BLAZE, :CLOUDNINE,
           :COMPETITIVE, :CORROSION, :DANCER, :DAZZLING, :DEFIANT, :FLAREBOOST, :DEFIANT,
           ...
           :SWARM, :TANGLINGHAIR, :TORRENT, :VENGEANCE],
    4  => [:ANGERPOINT, :BADDREAMS, :CHEEKPOUCH, :CLEARBODY, :CURSEDBODY, :BLACKSTAIN,
           :EARLYBIRD, :EFFECTSPORE, :FLAMEBODY, :FLOWERGIFT, :FULLMETALBODY,
           :GORILLATACTICS, :HYDRATION, :ICEFACE, :IMMUNITY, :INSOMNIA, :ETERNALDREAM,
           :JUSTIFIED, :MERCILESS, :PASTELVEIL, :POISONPOINT, :POISONTOUCH,
           :RIPEN, :SANDFORCE, :SOUNDPROOF, :STATIC, :SURGESURFER, :SWEETVEIL, :ICYVEINS,
           :SYNCHRONIZE, :VITALSPIRIT, :WATERCOMPACTION, :WATERVEIL, :BRANCHSWING,
           :WHITESMOKE, :WONDERSKIN, :VAMPIRIC, :SEEDSTIMULUS, :GROWINGTOOTH, :SEEWEED, :HYDROPONIC],
    3  => [:AROMAVEIL, :AURABREAK, :COTTONDOWN, :DAUNTLESSSHIELD,
           ...
           :OWNTEMPO, :PICKPOCKET, :RAINDISH, :RATTLED, :SANDVEIL, :INFLATABLE,
    ...
    0  => [:ANTICIPATION, :ASONECHILLINGNEIGH, :ASONEGRIMNEIGH, :BALLFETCH,
           ...
           :FRIENDGUARD, :FRISK, :GRIMNEIGH, :HEALER, :HONEYGATHER,
...
Battle::AI::Handlers::AbilityRanking.add(:ICYVEINS,
  proc { |ability, score, battler, ai|
    next score if battler.has_damaging_move_of_type?(:ICE, :WATER)
    next 2
  }
)
...
Battle::AI::Handlers::AbilityRanking.add(:SPELLCASTER,
  proc { |ability, score, battler, ai|
    next score if battler.has_damaging_move_of_type?(:FIRE, :ICE, :ELECTRIC)
    next 0
  }
)
...
Battle::AI::Handlers::AbilityRanking.add(:VENGEANCE,
  proc { |ability, score, battler, ai|
    next score if battler.has_damaging_move_of_type?(:GHOST)
    next 0
  }
)
