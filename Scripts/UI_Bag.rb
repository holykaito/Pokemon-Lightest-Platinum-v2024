...
class Window_PokemonBag < Window_DrawableCommand
  ...
  def drawItem(index, _count, rect)
    textpos = []
    rect = Rect.new(rect.x + 16, rect.y + 19, rect.width - 16, rect.height)
    thispocket = @bag.pockets[@pocket]
...
class PokemonBag_Scene
  ITEMLISTBASECOLOR     = Color.new(58, 58, 50)
  ITEMLISTSHADOWCOLOR   = Color.new(200, 200, 200)
  ITEMTEXTBASECOLOR     = Color.new(58, 58, 58)
  ITEMTEXTSHADOWCOLOR   = Color.new(200, 200, 200)
  POCKETNAMEBASECOLOR   = Color.new(58, 58, 50)
  POCKETNAMESHADOWCOLOR = Color.new(200, 200, 200)
  ITEMSVISIBLE          = 7
