...
class PokemonSummary_Scene
  ...
  RED_TEXT_BASE     = Color.new(230, 53, 26)
  RED_TEXT_SHADOW   = Color.new(246, 209, 205)
  BLACK_TEXT_BASE   = Color.new(54, 54, 54)
  BLACK_TEXT_SHADOW = Color.new(200, 200, 200)
  ...
  def drawPageOneEgg
    ...
    if @pokemon.hasItem?
      ...
      textpos.push([_INTL("None"), 16, 358, :left, Color.new(142, 150, 158), Color.new(208, 216, 224)])
    end
    # Draw all text
    pbDrawTextPositions(overlay, textpos)
  ...
  def drawPageThree
    ...
    textpos = [
      ...
      [sprintf("%d/%d", @pokemon.hp, @pokemon.totalhp), 462, 82, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Attack"), 248, 126, :left, base, statshadows[:ATTACK]],
      [@pokemon.attack.to_s, 456, 126, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Defense"), 248, 158, :left, base, statshadows[:DEFENSE]],
      [@pokemon.defense.to_s, 456, 158, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Sp. Atk"), 248, 190, :left, base, statshadows[:SPECIAL_ATTACK]],
      [@pokemon.spatk.to_s, 456, 190, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Sp. Def"), 248, 222, :left, base, statshadows[:SPECIAL_DEFENSE]],
      [@pokemon.spdef.to_s, 456, 222, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Speed"), 248, 254, :left, base, statshadows[:SPEED]],
      [@pokemon.speed.to_s, 456, 254, :right, Color.new(64, 64, 64), Color.new(200, 200, 200)],
      [_INTL("Ability"), 224, 290, :left, base, shadow]
    ]
    # Draw ability name and description
    ability = @pokemon.ability
    if ability
      textpos.push([ability.name, 362, 290, :left, Color.new(64, 64, 64), Color.new(200, 200, 200)])
      drawTextEx(overlay, 224, 321, 282, 2, ability.description, Color.new(64, 64, 64), Color.new(200, 200, 200))
    end
    # Draw all text
    pbDrawTextPositions(overlay, textpos)
    # Draw HP bar
