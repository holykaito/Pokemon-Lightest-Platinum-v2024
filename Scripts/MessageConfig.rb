...
module MessageConfig
  ...
  LIGHT_TEXT_SHADOW_COLOR  = Color.new(144, 160, 176) #(72, 80, 88)
  DARK_TEXT_MAIN_COLOR     = Color.new(50, 50, 50) #Color.new(80, 80, 88)
  DARK_TEXT_SHADOW_COLOR   = Color.new(200, 200, 200) #(160, 160, 168)
  MALE_TEXT_MAIN_COLOR     = Color.new(48, 118, 210)   # Used by message tag "\b"
  MALE_TEXT_SHADOW_COLOR   = Color.new(200, 200, 200)
  FEMALE_TEXT_MAIN_COLOR   = Color.new(195, 12, 12)   # Used by message tag "\r"
  FEMALE_TEXT_SHADOW_COLOR = Color.new(200, 200, 200)
  FONT_NAME                = "Voltaire" #"UTM Neo Sans Intel"
  FONT_SIZE                = 28
  FONT_Y_OFFSET            = 8
  SMALL_FONT_NAME          = "Voltaire" #"UTM Neo Sans Intel"
  SMALL_FONT_SIZE          = 22 #21
  SMALL_FONT_Y_OFFSET      = 8
  NARROW_FONT_NAME         = "Voltaire" #"UTM Neo Sans Intel"
  NARROW_FONT_SIZE         = 28
  NARROW_FONT_Y_OFFSET     = 8
  MEDIUM_FONT_NAME          = "Voltaire" #"UTM Neo Sans Intel"
  MEDIUM_FONT_SIZE          = 25 #24
  MEDIUM_FONT_Y_OFFSET      = 8
  MOVE_FONT_NAME          = "Voltaire" #"UTM Neo Sans Intel"
  MOVE_FONT_SIZE          = 23 #22
  MOVE_FONT_Y_OFFSET      = 8
  ...
  def self.pbDefaultMediumFontName
    return MessageConfig.pbTryFonts(MEDIUM_FONT_NAME)
  end
  ...
  def self.pbDefaultMoveFontName
    return MessageConfig.pbTryFonts(MOVE_FONT_NAME)
  end
  ...
  def self.pbGetMoveFontName
    @@narrowFont = pbDefaultMoveFontName if !@@moveFont
    return @@moveFont
  end
  ...
  def self.pbSetMoveFontName(value)
    @@narrowFont = MessageConfig.pbTryFonts(value)
    @@narrowFont = MessageConfig.pbDefaultMoveFontName if @@moveFont == ""
  end
...
# Sets a bitmap's font to the system medium font.
def pbSetMediumFont(bitmap)
  bitmap.font.name = MessageConfig.pbGetSmallFontName
  bitmap.font.size = MessageConfig::MEDIUM_FONT_SIZE
  bitmap.text_offset_y = MessageConfig::MEDIUM_FONT_Y_OFFSET
end
