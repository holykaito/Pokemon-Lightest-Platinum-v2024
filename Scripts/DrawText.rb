...
def drawFormattedTextEx(bitmap, x, y, width, text, baseColor = nil, shadowColor = nil, lineheight = 32)
  base = baseColor ? baseColor.clone : Color.new(46, 46, 46) #Color.new(96, 96, 96)
  shadow = shadowColor ? shadowColor.clone : Color.new(220, 220, 220) #Color.new(208, 208, 200)
