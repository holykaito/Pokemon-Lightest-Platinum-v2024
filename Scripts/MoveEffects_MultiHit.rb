...
#===============================================================================
# Two turn attack. Ups user's Speed by 1 stage first turn, attacks second turn.
# (Razor Wind)
#===============================================================================
class Battle::Move::TwoTurnAttackChargeRaiseUserSpeed1 < Battle::Move::TwoTurnMove
  attr_reader :statUp
  ...
  def pbChargingTurnMessage(user, targets)
    @battle.pbDisplay(_INTL("{1} is summoning the winds!", user.pbThis))
  end
