...
class AdventureTeraTypebox < AdventureAttributebox
  ...
  def refresh
    ...
    pbDrawTextPositions(self.bitmap, [[_INTL("Tera {1}", @attribute.name), (SLOT_BASE_WIDTH / 2) + 6, 20, :center, base, shadow, outline]])
  end
end
...
class AdventureMenuScene
  ...
  #-----------------------------------------------------------------------------
  # Generates the list of Tera types Pokemon can be given.
  #-----------------------------------------------------------------------------
