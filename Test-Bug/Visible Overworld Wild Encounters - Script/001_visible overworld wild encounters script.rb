...
module VisibleEncounterSettings
  ...
  DEFAULT_MOVEMENT = [1, 6, 1] # default [3, 3, 1]
  ...
  Enc_Movements = [                  # default
    [:shiny?, true, 3, 6, nil],    # [:shiny?, true, 3, 4, 3] means that shiny encounters will be faster
  ...
  Add_Steps_Before_Vanish = [ # default
    [:shiny?, true, -2]       # [:shiny, true, 8]       - means that spawned shiny pokemon will more 8 steps longer on the map than default.
	]
