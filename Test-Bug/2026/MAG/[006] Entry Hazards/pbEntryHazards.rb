...
alias mag_pbEntryHazards pbEntryHazards
  def pbEntryHazards(battler)
    ...
    # Call the original hazard method to handle standard hazards (Spikes, Sticky Web, Stealth Rock, etc.)
    mag_pbEntryHazards(battler)
  end
end